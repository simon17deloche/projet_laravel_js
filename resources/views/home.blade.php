            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @foreach($articles as $article)
                        <a href="" class="bg-gray-100 mb-8 rounded-lg group block rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-gray-200 hover:ring-gray-200">
